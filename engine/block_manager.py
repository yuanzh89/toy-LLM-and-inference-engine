...
class BlockManager:
    ...
    def __int__(self, num_blocks: int, block_size: int):
    ...
    def can_append(self, seq: Sequence) -> bool:
        """Does block manager has enough free blocks for the given sequence?"""
    ...
    def may_append(self, seq: Sequence) -> None:
        ...
        if len(seq) % self.block_size == 1:
            ...
            last_block.update(h, last_block.token_ids)

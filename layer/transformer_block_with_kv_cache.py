...
from swiglu_ffn import FusedSwiGLUFFNLayer
...
class TransformerBlock(nn.Module):
    def __init__(self,
                 ...
                 layer_id: int,
                 d_model: int, d_ff: int, num_query_heads: int, num_kv_heads: int, dropout: float = 0.1):
        super().__init__()
        ...
        self.ffn = FusedSwiGLUFFNLayer(self.d_model, self.d_ff, dropout=self.dropout)
